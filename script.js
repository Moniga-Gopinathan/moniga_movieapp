...
function displayMovieDetails(details) {
    ...
    <div class="movie-info">
        ...
        <button class="fav-button" onclick="addToFavorites('${details.imdbID}')">Add to Favorites</button>
    </div>
    `;
}
...
async function displayFavoriteMovies() {
    ...
    for (const id of favoriteMovies) {
        ...
        favoriteItem.innerHTML = `
            ...
            <button class="fav-button remove" onclick="removeFromFavorites('${details.imdbID}')">Remove</button>
        `;
